...
import { createUser } from '@/services/erpnextApi';
...
export function SignupPage({ onSignupComplete }: SignupPageProps) {
  ...
  // Initialize supplier data from URL
  useEffect(() => {
    if (!supplierData) {
      initializeFromUrl();
    }
  ...
  // Loading state - show while fetching supplier data
  if (storeLoading || !supplierData) {
    return (
