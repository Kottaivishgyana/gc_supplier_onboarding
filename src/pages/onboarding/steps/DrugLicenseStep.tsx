    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col gap-2">
        ...
        <p className="text-muted-foreground">
          Enter your Drug License Number. This is a custom field for additional verification.
        </p>
      </div>
      ...
      <Card>
        <CardContent className="pt-6">
          <div className="flex flex-col gap-6">
            ...
            {drugLicense.drug_license_number && (
              <div className="flex flex-col gap-2">
...
export function validateDrugLicense(data: {
  ...
  // Drug license is optional, but if number is provided, document is recommended
  if (data.drug_license_number.trim() && data.drug_license_document) {
    if (data.drug_license_document.size > 5 * 1024 * 1024) {
